...
test('student login sends Projeto LM users to LM 2.0 and keeps Premium on portal.html', () => {
  assert.match(portalLogin, /r\.data\.plan==='projeto_lm'\?'public\/project-lm-2\.html':'portal\.html'/);
  assert.doesNotMatch(portalLogin, /r\.data\.plan==='premium'\?'public\/project-lm-2\.html'/);
});
