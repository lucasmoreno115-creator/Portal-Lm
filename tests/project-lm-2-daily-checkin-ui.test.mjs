...
test('LM 2.0 home consumes progress endpoint and shows 5-day continuity target', () => {
  ...
  assert.match(lm2App, /lm2-progress-card/);
  assert.match(lm2App, /Você manteve sua rotina em \$\{state\.continuity_days_count\} dos últimos \$\{state\.required_days_count\} dias necessários/);
