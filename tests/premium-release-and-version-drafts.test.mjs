...
test('record and workspace keep release operations on the record surface',()=>{
  ...
  assert.equal(fs.readFileSync('public/admin-premium-student-record.js','utf8'),fs.readFileSync('public/assets/js/admin-premium-student-record.20260810-2.js','utf8'));
