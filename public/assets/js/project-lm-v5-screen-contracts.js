(function initProjectLmV5ScreenContracts(globalScope) {
  ...
  const screens = Object.freeze([
    Object.freeze({ key: 'journey_overview', title: 'Sua Direção', subtitle: 'Siga um passo de cada vez. Não é necessário fazer tudo.', route: '#project-lm/journey', stage_key: null, required_status: null, empty_state: 'Sua direção será construída passo a passo. Vamos começar.', locked_state: STATE_MESSAGES.locked, completed_state: STATE_MESSAGES.completed, primary_action: 'open_current_stage', secondary_action: null, form_contract: null }),
    ...
    Object.freeze({ key: 'stage_2_plan_b', title: 'Plano B — Dias Difíceis', subtitle: 'Quando o dia não sair como planejado, sua direção continua.', route: '#project-lm/plan-b', stage_key: 'stage_2', required_status: 'active', empty_state: 'Os dias difíceis vão acontecer. Prepare sua resposta antes deles chegarem.', locked_state: STATE_MESSAGES.locked, completed_state: STATE_MESSAGES.completed, primary_action: 'savePlanB', secondary_action: null, form_contract: formContracts.stage_2_plan_b }),
    Object.freeze({ key: 'stage_3_victories', title: 'Vitórias da Jornada', subtitle: 'Registre momentos em que você escolheu continuar.', route: '#project-lm/victories', stage_key: 'stage_3', required_status: 'active', empty_state: 'Toda mudança começa com uma pequena vitória. Quando ela acontecer, registre aqui.', locked_state: STATE_MESSAGES.locked, completed_state: STATE_MESSAGES.completed, primary_action: 'createVictory', secondary_action: null, form_contract: formContracts.stage_3_victories }),
    Object.freeze({ key: 'stage_4_recovery', title: 'Voltar para a Direção', subtitle: 'Sair do plano faz parte. Voltar faz a diferença.', route: '#project-lm/recovery', stage_key: 'stage_4', required_status: 'active', empty_state: 'Sair do plano faz parte. Voltar faz a diferença.', locked_state: STATE_MESSAGES.locked, completed_state: STATE_MESSAGES.completed, primary_action: 'saveRecovery', secondary_action: null, form_contract: formContracts.stage_4_recovery }),
    Object.freeze({ key: 'maintenance_goals', title: 'Sua Evolução', subtitle: 'Pequenos avanços acumulados criam grandes transformações.', route: '#project-lm/maintenance', stage_key: 'maintenance', required_status: 'maintenance', empty_state: 'Pequenos avanços acumulados criam grandes transformações.', locked_state: STATE_MESSAGES.locked, completed_state: STATE_MESSAGES.completed, primary_action: 'createMaintenanceGoal', secondary_action: null, form_contract: formContracts.maintenance_goals })
  ]);
