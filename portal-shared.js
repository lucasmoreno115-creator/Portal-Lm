...
function logout(){localStorage.removeItem('lm_student_email');localStorage.removeItem('lm_student_token');localStorage.removeItem('lm_student_name');window.location.href='portal-login.html';}
function requireAuth(){const {email,token}=getAuth();if(!email||!token) window.location.href='portal-login.html';}
function nav(){return `<nav><a href='portal.html'>Início</a><a href='portal-checkin.html'>Check-in</a><a href='portal-progressao.html'>Progressão</a><a href='portal-plano-alimentar.html'>Plano Alimentar</a><a href='portal-biblioteca.html'>Biblioteca</a><button onclick='logout()'>Sair</button></nav>`}
