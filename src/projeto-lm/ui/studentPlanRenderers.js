...
function renderExerciseMedia(exercise) {
  ...
  const src = escapeHtml(exercise.gif);
  const alt = escapeHtml(`Demonstração do exercício ${exercise.name || ''}`.trim());
