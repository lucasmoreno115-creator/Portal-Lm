...
import {analyzePerformanceReport,analysisMarkdown,exitCodeForAnalysis} from './lib/portal-performance-analysis.mjs';
...
process.exitCode = exitCodeForAnalysis(analysis.status);
