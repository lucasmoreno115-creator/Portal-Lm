...
// POST create, professional GET and draft PATCH all use presentAdminNutritionPlan,
// which deliberately omits the persistence-only is_active column. Draft creation
// is therefore established here by identity and lifecycle status; the independent
// professional reload below proves that it is not the current published plan.
